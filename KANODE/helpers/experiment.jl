...
#This defines a set of reusable tools for running a KANODE experiment
struct UDEExperiment 
    true_ODE::Function
    UDE::Function
    neuralnet::Function
    generate_data_params::NamedTuple
end
...
function generate_data(params::GenerateDataParams)
    dt::Float32 =0.1f0,
