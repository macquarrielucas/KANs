...
model = CustomDerivatives(data, lotka_voltera!, initial_parameters, obs_weight = 0, reg_weight = 0)
##Plotting
...
spinning_rate=0.5
static_data = StaticData(x,y,xy,true_h,tspan_train, u0, spinning_rate)
...
@time for i in iterator
    ...
    #loss_curr_test=deepcopy(loss_test(p))plt = plot(layout=(2,2), size=(1600, 1200), titlefontsize=12)
